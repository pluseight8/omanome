...
class OmanomeProjectTests(unittest.TestCase):
    ...
    def test_10_release_and_performance_contract_are_documented(self) -> None:
        ...
        self.assertIn("runnable 1.4.0 release", readme)
        self.assertIn("версии 1.4.0", readme_ru)
    ...
    def test_companion_contract_is_optional_and_version_aware(self) -> None:
        ...
        self.assertEqual(metadata["pluginVersion"], "1.4.0")
        ...
        result = self.run_node(
            ...
            "const good={installed:true,built:true,loaded:true,protocolVersion:2,pluginVersion:'1.4.0'," \
            "runtime:{version:'0.56.2',abi:'same'},build:{version:'0.56.2',abi:'same',pluginBuild:'1.4.0'}," \
            "versionMatch:true,pluginBuildMatch:true,artifactHashMatch:true,compatibility:{pluginVersion:'1.4.0'}," \
