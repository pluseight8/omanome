...
class OmanomeProjectTests(unittest.TestCase):
    ...
    def test_companion_contract_is_optional_and_version_aware(self) -> None:
        ...
        result = self.run_node(
            ...
            "const good={installed:true,built:true,loaded:true,protocolVersion:2,pluginVersion:'0.7.0'," \
            "runtime:{version:'0.56.2',abi:'same'},build:{version:'0.56.2',abi:'same',pluginBuild:'0.7.0'}," \
            "versionMatch:true,pluginBuildMatch:true,artifactHashMatch:true,compatibility:{pluginVersion:'0.7.0'}," \
