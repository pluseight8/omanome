...
constexpr std::string_view kPluginVersion = "0.9.0";
...
std::string statusCommand(eHyprCtlOutputFormat format, std::string arguments) {
    ...
    if (format == FORMAT_JSON) {
        ...
        return "omanome-effects protocol=2 version=0.9.0 wobbly=" + std::string(g_wobblyManager && g_wobblyManager->available() ?
