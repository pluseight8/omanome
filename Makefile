...
.PHONY: check validate test qmllint integration companion-check hardware-test device-check dependency-audit performance-test performance-check version-check input-check multitasking-check adaptive-check
...
device-check:
	python3 -m unittest tests.test_device_check -v
	python3 scripts/device_check.py --fixture tests/fixtures/hardware-device-graph.json --json
...
adaptive-check:
	python3 -m unittest tests.test_adaptive tests.test_adaptive_check -v
	python3 scripts/adaptive_check.py --fixture tests/fixtures/hardware-adaptive.json --json
	python3 scripts/performance_check.py --json
