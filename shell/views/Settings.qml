        ...
        Flickable {
          ...
          Column {
            ...
            Column {
              ...
              ActionButton { width: parent.width; visible: root.category === "updates"; text: root.service.tr("checkUpdates", "Check"); subtitle: root.service.tr("manualUpdates", "Updates are never installed automatically"); onClicked: root.service.refreshEffectBackend() }
              Text { width: parent.width; visible: root.category === "updates"; text: root.service.tr("updateHint", "Use omanome update --check, update and rollback for explicit versioned actions."); color: Color.muted; font.pixelSize: Style.font.caption; wrapMode: Text.WordWrap }
