        ...
        Flickable {
          ...
          Column {
            ...
            Column {
              ...
              ActionButton { width: parent.width; visible: root.category === "displays"; text: root.service.tr("deviceCenter", "Open Device Center"); subtitle: root.service.tr("deviceCenterHint", "Profiles, explicit display mapping and calibration"); icon: "⌁"; onClicked: if (root.panel) { root.panel.activeView = "devices"; root.panel.payloadView = "devices://displays" } }
            }
