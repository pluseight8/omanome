...
function defaults() {
  return {
    ...
    multitasking: { enabled: true, gap: 12, minimumWindowSize: { width: 320, height: 240 }, layouts: [], customLayouts: [], snapAssist: { enabled: true, dwellMs: 220, movementThreshold: 18, stylusDwellMs: 120, preview: true, edgeZones: true, sensitivity: 1.0 }, splitView: { divider: true, defaultRatio: "50/50", rememberRatio: true, autoConvertOnRotation: true, autoHide: true, autoHideMs: 1800, handleSize: 48 }, groups: [], sessionRestore: "ask", closePolicy: "keep", monitorPolicy: "active", maxGroups: 32, experimentalWindowThrow: false },
