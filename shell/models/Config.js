function defaults() {
  return {
    ...
    effects: { wobblyWindows: false, desktopCube: false, companionPolicy: "auto", existingCubeBackend: "detect", disableOnBattery: true, disableOnFullscreen: true, performanceMode: "balanced" },
