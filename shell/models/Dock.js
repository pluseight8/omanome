...
function config(config) {
  ...
  return {
    ...
    runningApplications: dock.runningApplications !== false,
    showLauncher: dock.showLauncher !== false,
    showSettings: dock.showSettings === true,
    showTrash: dock.showTrash === true,
    multipleWindowAction: String(dock.multipleWindowAction || "cycle"),
